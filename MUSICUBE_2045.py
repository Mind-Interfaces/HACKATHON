...
from moviepy.audio.fx import all as moviepy_audio_fx_all
...
warp_sound = pygame.mixer.Sound('warp.wav')  # Game Over
...
# Player Cube
global player_x, player_z, player_flashing
player_x = 0
player_y = -1.5
player_z = 0
...
obs_speed = 0.1  # Starting obstacle speed
...
def main():
    ...
    while True:
            ...
            if z < 5:
                ...
                if is_collision(player_x, player_y, player_z, x, y, z):
                    if player_flashing:
                        ...
                        obs_id = ""
                        if color==(0, 1, 1):
                            score += 1000  # Add 100 points
                            turbo_speed += 30 # Move faster
                            warp_sound.play()
                        else:
                        ...
                        clock.tick(turbo_speed)
                else:
                    turbo_speed = base_speed
        ...
        drawText((2.15, 1.8, 0), f'{lives}', color=(255, 255, 255, 255))
